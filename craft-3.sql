...
CREATE TABLE `assetindexdata` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_khuapsemjgsgevuykwqgqfdwudqzycgdcwnd` (`sessionId`,`volumeId`),
...
CREATE TABLE `assettransformindex` (
  ...
  `uid` char(36) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_eflmpiwyvmbkafrtrrzwtdtgxbufhdzxjxsk` (`volumeId`,`assetId`,`location`),
  KEY `idx_offgfgtwatmlaldwrgnefkdfsruyobnymlrt` (`assetId`,`format`,`location`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `drafts` (
  ...
  KEY `fk_nzgwfevucjjrncsnmyiicavjkmghmackewtj` (`sourceId`),
  CONSTRAINT `fk_nzgwfevucjjrncsnmyiicavjkmghmackewtj` FOREIGN KEY (`sourceId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `elementindexsettings` (
  ...
  `uid` char(36) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_uoenqskccwhtczyygqjbtabdcdnjtzduyhjr` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `info` VALUES (1,'3.7.38','3.7.33',0,'lnovnwxhsyyn','3@xeloiyujnl','2022-04-21 10:33:01','2022-04-21 10:33:14','076a1933-b649-4bd6-bd9b-9cf51584323f');
...
CREATE TABLE `matrixblocks` (
  ...
  `uid` char(36) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_gykzjmmtecoigrvxmnkngijlrbojjyxyrczw` (`ownerId`),
  KEY `idx_zwrblvwjksblwkdwplwckrzslpmcfkwrrhcp` (`fieldId`),
  KEY `idx_gkzmhotraayabwiszfaqdhmyagalbabaqabt` (`typeId`),
  KEY `idx_cgunuggkykljxiiravmvyrwuwdtyhzpxqysv` (`sortOrder`),
  ...
  CONSTRAINT `fk_rlnotmklzykndhzkbmuurkrxkphtwpazlxps` FOREIGN KEY (`ownerId`) REFERENCES `elements` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `revisions` (
  ...
  `notes` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_dgnejthoezysdegdfzzrzqiqxwqlihdzpzsk` (`sourceId`,`num`),
  ...
  CONSTRAINT `fk_tvggbjlybqthksiapadmjlbeekfixtvqtcvg` FOREIGN KEY (`sourceId`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `templatecacheelements` (
  ...
  `elementId` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_ilohmuvxibthzgdzhndeawmfzsxmymillzkt` (`cacheId`),
  KEY `idx_icvkuzuwdmhliijwarwsykzcuyeroagmccdu` (`elementId`),
  CONSTRAINT `fk_bptoqbvbiadmiwqmhhwolyddfjorsplxwium` FOREIGN KEY (`cacheId`) REFERENCES `templatecaches` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_pomslyfcckwukdtuehnlztbpebsqjjelmyrz` FOREIGN KEY (`elementId`) REFERENCES `elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `templatecachequeries` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_gymxjwwxvqbofisblrysooaywdzmqalbyfgu` (`cacheId`),
  KEY `idx_rktjhgsfslguzhsdfnadgobbdkpznooxqmcm` (`type`),
  CONSTRAINT `fk_bkbsfaoqtldslxjpnjhxihqdkuluylrnroio` FOREIGN KEY (`cacheId`) REFERENCES `templatecaches` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `templatecaches` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_udnolhwedacaebtykgubpzgpwebmombjzswj` (`cacheKey`,`siteId`,`expiryDate`,`path`),
  KEY `idx_whkpnrdooqybteguoffniwajfzbsocmfelmg` (`cacheKey`,`siteId`,`expiryDate`),
  KEY `idx_dozkuzmnctlfwlskuzbpprskgkrvqksfveic` (`siteId`),
  CONSTRAINT `fk_jfltmnwgjicmbjrurxzynebldflkzorangrl` FOREIGN KEY (`siteId`) REFERENCES `sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `uid` char(36) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_yosojmvzqweynnadliemyfnooiypkcyqwkvv` (`uid`),
...
INSERT INTO `users` VALUES (1,'admin',NULL,NULL,NULL,'tom@tomdavies.net','$2y$13$yQb5Q0sR/HpJR7MwlF8Y7uXgddKTS56F.jmGthLoRYORZMxccMdra',1,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,0,'2022-04-21 10:33:02','2022-04-21 10:33:02','2022-04-21 10:33:02','0dc1242e-b79b-466e-8a61-75df4433762e');
...
-- Dump completed on 2022-04-21 10:49:37
